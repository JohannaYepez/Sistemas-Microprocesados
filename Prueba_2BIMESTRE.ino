...
void reinicio() { //metodo de reinicio
  ...
  n4= random(1,3);
  n5= random(1,3);
  EEPROM.update(n1,0); //actualizar contraseña pos1
  EEPROM.update(n2,1); //actualizar contraseña pos2
  EEPROM.update(n3,2); //actualizar contraseña pos3
  EEPROM.update(n4,3); //actualizar contraseña pos4
  EEPROM.update(n5,4); //actualizar contraseña pos5
